    ...
    @auth
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            <a href="{{ route('home') }}" class="brand-link">
                <img src="{{ asset('assets/img/google_trends_logo.jpg') }}" alt="Google Trends Bot" class="brand-image">
                ...
                <div style="direction: rtl">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="{{ route('google.trends.index') }}" class="nav-link text-black-50" id="google">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('links.index') }}" class="nav-link text-black-50" id="links">
